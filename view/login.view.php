...
<head>
    ...
    <!-- Bootstrap CSS CDN (optional, for better appearance) -->
    ...
    <div class="row justify-content-center">
        <div class="col-xl-10">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="post" action="/projeklogin/login">
                                    ...
                                    <button type="submit" class="btn btn-theme" name="login">Login</button>
                                    <a href="/projeklogin/forgot" class="forgot-link float-right text-primary">Forgot password?</a>
                                </form>
                            </div>
                        </div>
            ...
            <p class="text-muted text-center mt-3 mb-0">
                ...
                <a href="/projeklogin/register" class="text-primary ml-1">Register</a>
            </p>
            <!-- Hapus/Nonaktifkan form collapse register di bawah ini karena sudah ada halaman register sendiri -->
            <!--
            <div class="collapse mt-3" id="register">
